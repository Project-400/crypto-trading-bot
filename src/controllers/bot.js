...
exports.trade = exports.sellCurrency = exports.stopBot = exports.startBot = void 0;
...
exports.trade = async (req, res) => {
    const response = await trader_bot_1.TraderBot.watchPriceChanges('YFIBTC', 'YFI', 'BTC');
    res.status(200).json({ response });
};
